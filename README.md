...
├── fetch_cdc.sh         # Load R module + run fetch_cdc.R (pass flags through)
├── fetch_env.sh         # Load R module + run fetch_env.R
...
│                   └── county_*.txt
│
├── CDC_wonder_api/      # Research notes and request/response samples for CDC WONDER API
